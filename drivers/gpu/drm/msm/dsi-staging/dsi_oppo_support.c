...
int set_oppo_display_vendor(const char * display_name) {
    ...
    if (!strcmp(display_name,"dsi_samsung_fhd_plus_dsc_cmd_display")) {
        ...
        oppo_display_vendor = RM_19631_ILI9881H_TRULY_HD_VIDEO_PANEL;
        register_device_proc("lcd", "ILI9881h", "truly vdo");
    } else if (!strcmp(display_name,"dsi_ili9881h_innolux_inx_video_display")) {
        oppo_display_vendor = RM_19631_ILI9881H_INNOLUX_HD_VIDEO_PANEL;
        register_device_proc("lcd", "ILI9881h", "innolux vdo");
    } else if (!strcmp(display_name,"dsi_nt36525b_hlt_boe_video_display")) {
        oppo_display_vendor = RM_19631_NT36525B_HLT_HD_VIDEO_PANEL;
        register_device_proc("lcd", "NT36525B", "hlt boe vdo");
    } else {
